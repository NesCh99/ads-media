...
class RolController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        $name = $rol->name;
        if($rol->name == 'Administrador' || $rol->name == 'Gestor de Contenido'){
            return redirect()->route('admin.roles.index')->with("info", 'El rol '.$name.' no se puede eliminar');    
        }
        $rol->delete();
        return redirect()->route('admin.roles.index')->with("info", 'El rol '.$name.' ha sido elimnado');
    }
}
