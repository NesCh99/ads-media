                                    ...
                                    <div class="px-3 md:w-6/12 lg:pr-10">
                                        ...
                                        <div class="mb-6 pb-6 border-b border-gray-200 text-gray-800">
                                            <div class="w-full flex mb-3 items-center">
                                                ...
                                                <div class="pl-3">
                                                    <span class="font-semibold">${{ $video->PrecioVid }}</span>
                                                </div>
                                            </div>
                                            <div class="w-full flex items-center">
                                                <div class="flex-grow">
                                            ...
                                            <div class="w-full flex items-center">
                                                ...
                                                <div class="pl-3">
                                                    <span class="font-semibold text-gray-400 text-sm">USD</span> <span
                                                        class="font-semibold">${{ $video->PrecioVid }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="px-3 md:w-6/12">
                                                            ...
                                                            <div class=" md:p-0 w-full transform transition duration-300 ease-in-out border-b "
                                                                ...
                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span class="form-required">*</span>
                                                                        {!! Form::tel('Phone', $cliente->billing->telefono, [
                                                                            'pattern' => '[0]{1}[0-9]{9}',
                                                                            'maxlength' => '10',
                                                                            'class' => 'form-control w-full rounded-md border bg-white py-2 px-2 outline-none ring-blue-600 focus:ring-1',
                                                                        ]) !!}
                                        ...
                                        <div
                                            ...
                                            <div class="w-full p-3 border-b border-gray-200">
                                                ...
                                                @if ($cliente->billing)
                                                    <form method="POST"
                                                        action="{{ route('cliente.pago.paypal.video', $video->idVideo) }}"
                                                                ...
                                                                <script>
                                                                    paypal.Buttons({
                                                                        ...
                                                                        onApprove: function(data, actions) {
                                                                            return fetch('/streaming/pago/paypal/video/' + data.orderID + '?idVideo=' +
                                                                                    {{ $video->idVideo }})
                                                                                ...
                                                                                .then(function(response) {
                                                                                    ...
                                                                                    if (!response.success) {
                                                                                        const failureMessage = 'Lo sentimos, no se ha podido procesar la transacción.';
