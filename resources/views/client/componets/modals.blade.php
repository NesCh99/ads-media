...
<div id="modal-info2" class="zoom-anim-dialog mfp-hide modal modal--info">
    ...
    <div class="sign__group sign__group--row">
        ...
        <span class="sign__text sign__text--small">There are many variations of passages of Lorem Ipsum
            available, but the majority have suffered alteration in some form, by injected humour, or randomised
            words which don't look even slightly believable.</span>
    </div>
</div>
<!-- end modal info -->
