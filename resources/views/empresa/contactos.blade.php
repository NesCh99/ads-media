        ...
        <main class="main">
            <div class="container-fluid">
                <div class="row row--grid">
                    ...
                    <div class="col-12">
                        <ul class="breadcrumb">
                            <li class="breadcrumb__item"><a href="{{ route('cliente.home') }}"> <i
                                        class="fa-solid fa-house" style="margin-right: 8px"></i> Inicio
                                </a></li>
                            <li class="breadcrumb__item breadcrumb__item--active"> <i
                                    class="fa-solid fa-caret-right"></i> Términos y Condiciones</li>
                        </ul>
                    </div>
                    <!-- end breadcrumb -->
