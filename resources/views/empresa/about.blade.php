<x-app-layout>
    ...
    <main class="page has-sidebar">
        ...
        <!-- component -->
        <link href="https://fonts.googleapis.com/css?family=Mitr|Roboto+Slab|Source+Sans+Pro&display=swap"
            rel="stylesheet">
        ...
        <div class="bg-indigo-900 relative overflow-hidden">
            ...
            <div class="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-24 xl:py-40">
                <div class="lg:w-3/5 xl:w-2/5 flex flex-col items-start relative z-10">
                    <span class="font-mitr uppercase text-indigo-500">Live Streaming</span>
                    <h1 class="font-roboto-slab text-4xl sm:text-6xl text-red-400 leading-tight mt-4">
                        {{ $company->name }} <br> </h1>
                    <div class="max-w-md">
                        <p class="font-source-sans-pro text-indigo-500 mt-6 text-lg">{{ $company->slogan }}</p>
                    </div>
                    <a href="{{ route('cliente.home') }}"
                        class="block bg-indigo-500 hover:bg-indigo-400 py-2 px-4 rounded-full text-sm font-mitr text-white uppercase mt-10">Iniciar</a>
                </div>
                <svg class="hidden sm:block absolute bottom-0 right-0 -mr-40 lg:mr-0" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <defs />
                    <defs>
                        <radialGradient id="a" cx="416.96" cy="273.37" r="226.21"
                    ...
                    <g data-name="Capa 1">
                        ...
                        <circle cx="338.06" cy="135.84" r="13.93" fill="none" stroke="#5c4f84"
                            stroke-miterlimit="10" stroke-width=".735" transform="rotate(-22.72 338.064 135.833)" />
                        <circle cx="304.19" cy="187.52" r="10.74" fill="none" stroke="#5c4f84"
                            stroke-miterlimit="10" stroke-width=".735" transform="rotate(-80.82 304.168 187.524)" />
                        ...
                        <circle cx="337.46" cy="135.87" r="9.46" fill="#b96a51"
                        ...
                        <circle cx="304.62" cy="187.81" r="7.09" fill="#7e9acc"
                        ...
                        <circle cx="476.81" cy="149.82" r="9.43" fill="none" stroke="#5c4f84"
                            stroke-miterlimit="10" stroke-width=".798" />
                        <circle cx="476.81" cy="149.82" r="14.36" fill="none" stroke="#514575"
                            stroke-dasharray="2.255 2.255 0 2.255 2.255 0" stroke-linecap="round"
                            stroke-miterlimit="10" stroke-width="1.102" />
                        <circle cx="338.06" cy="135.84" r="21.74" fill="none" stroke="#514575"
                            stroke-dasharray="3.414 3.414 0 3.414 3.414 0" stroke-linecap="round"
                            stroke-miterlimit="10" stroke-width="1.102" transform="rotate(-31.72 338.036 135.845)" />
                        ...
                        <ellipse cx="511.08" cy="327.03" fill="#7e587b" opacity=".5" rx="5.3"
                            ry="3.58" style="mix-blend-mode:lighten"
                            transform="rotate(-23.71 511.074 327.023)" />
                        <path fill="#7e587b" d="M505.64 332.27a2.34 2.34 0 11-2.85-.79 2.12 2.12 0 012.85.79z"
                            opacity=".5" style="mix-blend-mode:lighten" />
                        <path fill="#3b335f"
                ...
                <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    ...
                    @foreach ($company->services as $service)
                        <div>
                            ...
                            <h3 class="mb-2 text-xl font-bold dark:text-white">{{ $service->name }}</h3>
                            <p class="text-gray-500 dark:text-gray-400">{{ $service->body }}
                            </p>
                        </div>
                    @endforeach
        ...
        <section class=" dark:bg-gray-900">
            <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                    ...
                    <p class="mb-4">{{ $company->information }}
                    </p>
                ...
                <div class="grid grid-cols-2 gap-4 mt-8">
                    ...
                    @if ($company->image)
                        <img class="w-full rounded-lg" src="{{ Storage::url($company->image) }}"
