...
<div class="card-header bg-dark">
    <div class="row align-items-center">
        <h5><b>SUSCRIPCIONES| </b>Suscripciones por video transmitido</h5> 
    </div>
</div>
@stop
...
@section('content')
    ...
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200" style="padding-top: 10px">
        SUSCRIPCIONES| Gráficos Estadísticos
    </h2>
    ...
    <form method="POST" action="{{ route('admin.suscripciones') }}">
        @csrf
        <div class=" mx-auto flex">
            <div class="flex-auto w-64">

                <label for="fecha" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Suscripciones
                    mensuales</label>
                <select name="Años"
    ...
    <div class="w-full max-w-full px-3 mt-0 lg:flex-none pb-8">
        <div
            ...
            <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                <h6>Suscripciones Mensuales </h6>

                <p class="leading-normal text-sm">
                    <i class="fa fa-arrow-up text-lime-500"></i>

                    @if ($año === 'Todos los años' || is_null($año))
                        <span class="font-semibold"></span> Suscripciones Generales
                    @else
                        <span class="font-semibold">del año</span> in {{ $año }}
                    @endif
...
@section('js')
    ...
    <script>
        const pagos = JSON.parse(`<?php echo $suscripcionMensual; ?>`)
