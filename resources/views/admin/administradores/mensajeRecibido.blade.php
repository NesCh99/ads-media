            ...
            <td align="center" data-bgcolor="Body" bgcolor="#FFFFFF" data-composer>
                                ...
                                <tr data-element="blue-logo" data-label="Logo">
                                    <td align="center" class="center-text">
                                        <img style="width:120px;border:0px;display: inline!important;"
                                            src="http://127.0.0.1:8000/img/logo.png" width="120" border="0"
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr data-element="blue-headline" data-label="Headlines">
                                                <td class="center-text" data-text-style="Headlines" align="center"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            Debajo puedes encontrar tu contraseña temporal
                                                        </div>
                                                    </singleline>
                                                </td>
                                            </tr>
                                                ...
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            ...
                                                            <span>
                                                                <p>Tu cuenta es válida hasta:
                                                                    <strong>{{ $msg['Fecha'] }}</strong></p>
                                                            </span>
                                                            <br>
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td align="center" data-border-radius-default="0,6,36"
                                                                ...
                                                                data-bgcolor="Buttons" bgcolor="#0387EC"
              ...
              <table border="0" cellpadding="0" cellspacing="0" align="center">
                <tr>
                  ...
                  <![endif]-->
                                                                <singleline>
                                                                    <a href="{{ route('login') }}" mc:edit data-button
                                                                        data-text-style="Buttons"
                                                                        style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding: 15px 35px 15px 35px;display: inline-block;"><span>Iniciar
                                                                            Sesión</span></a>
                                                                </singleline>
                                                                <!--[if (gte mso 9)|(IE)]>
                  </td>
                                                ...
                                                <td align="center">
                                                    <table border="0" align="center" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-element="blue-footer-twitter"
                                                                data-label="Twitter" class="rwd-on-mobile"
                                                                align="center" valign="middle" height="36"
                                                                style="height: 36px;">
                                                                <table border="0" align="center" cellpadding="0"
                                                                    cellspacing="0" role="presentation">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="center-text" data-text-style="Paragraphs" align="center"
                                                    ...
                                                    <multiline>
                                                        <div mc:edit data-text-edit>
                                                            Somos el canal digital de la Agencia de Publicidad ADS<br>
                                            ...
                                            <tr class="center-on-mobile">
                                                <td data-element="blue-footer-unsubscribe" data-label="Unsubscribe"
                                                    ...
                                                    <unsubscribe href="#" data-mergetag="Unsubscribe"
                                                        ...
                                                        STREAMING DEPORTIVO E INSTITUCIONAL</unsubscribe>
                                                </td>
                                                ...
                                                <td data-element="blue-footer-webversion" data-label="Web version"
                                                    ...
                                                    <webversion href="#" data-mergetag="Web version"
                                                        style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">
                                                        MEDIO DIGITAL DE NOTICIAS</webversion>
                                                </td>
                                                ...
                                                <td data-element="blue-footer-forward" data-label="Forward"
                                                    ...
                                                    <forward href="#" data-mergetag="Forward"
                                                        style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">
                                                        PRODUCCION Y POSTPRODUCION DE VIDEOS, SPOTS</forward>
                                                </td>
                                                ...
                                                <td data-element="blue-footer-forward" data-label="Forward"
                                                    ...
                                                    <forward href="#" data-mergetag="Forward"
                                                        style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">
                                                        DISEÑO GRAFICO MULTIMEDIA PROFESIONAL</forward>
                                                </td>
                                                ...
                                                <td data-element="blue-footer-forward" data-label="Forward"
                                                    ...
                                                    <forward href="#" data-mergetag="Forward"
                                                        style="font-family:'Barlow',Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#666666;text-decoration:none;">
                                                        FOTOGRAFIA DIGITAL COMERCIAL</forward>
                                                </td>
